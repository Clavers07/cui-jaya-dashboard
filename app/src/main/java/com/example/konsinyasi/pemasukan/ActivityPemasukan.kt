...
import com.example.konsinyasi.databinding.ActivityPemasukanBinding
    ...
    fun getLists() {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                val titipanColumnIndex = cursor.getColumnIndexOrThrow("titipan")
                val nilaiColumnIndex = cursor.getColumnIndexOrThrow("nilai")
                val komisiColumnIndex = cursor.getColumnIndexOrThrow("komisi")
                ...
                val titipan = cursor.getInt(titipanColumnIndex)
                val nilai = cursor.getInt(nilaiColumnIndex)
                val komisi = cursor.getInt(komisiColumnIndex)
                val keterangan = cursor.getString(catatanColumnIndex)
                val tanggal = cursor.getString(tanggalColumnIndex)

                sum += nilai

                val data: Pemasukan = Pemasukan(id, id_sumber, nama, titipan, nilai, komisi, keterangan, tanggal)
